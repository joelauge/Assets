    ...
    public class GameUpdater : MonoBehaviour
    {
        ...
        void UpdateFile()
        {
            if (updatingIndex < updateList.Count)
            {
                ...
                WWW www = new WWW(remoteVersionFileURL + "/../" + updatingName + suffix);
        ...
        {      
            ...
            File.WriteAllText(Application.temporaryCachePath + "/" + localVersionFileRelativePath, JsonMapper.ToJson(localVersionConfig));
        }
