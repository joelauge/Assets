...
internal class GameUpdaterStyle
{
    ...
    private static GameUpdaterStyle getInstance()
    {
        if (instance == null)
        {
            ...
            GameUpdaterStyleSet styleSet = (GameUpdaterStyleSet)AssetDatabase.LoadAssetAtPath("Assets/GameUpdater/GameUpdaterStyleSet.asset", typeof(GameUpdaterStyleSet));
