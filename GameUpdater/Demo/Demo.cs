...
public class Demo : MonoBehaviour
{
	...
	void Start ()
	{
		...
		updater.DoUpdate("publish/vc", "https://joelauge.github.io/theresachance/publish/", "password");
    ...
    void LoadAssets()
    {
		...
		Instantiate(updater.LoadAssetBundle("angel").LoadAsset("Angel"));
		Instantiate(updater.LoadAssetBundle("artarget").LoadAsset("Artarget"));
